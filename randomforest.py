...
def main():
	...
	for i in range(no_of_folds):
		...
		acc_values_randomforest.append(accuracy)
	...
	with open('randomforest_acc.data','w') as f:
		for x in range(len(acc_values_randomforest)):
			f.write(str(acc_values_randomforest[x])+"\n")
